...
describe("blogService", () => {
  ...
  describe("getBlogDetail()", () => {
    ...
    // TC_BLOG_08
    test("TC_BLOG_08 — Ném lỗi khi blogModel.findById() ném lỗi DB", async () => {
  ...
  describe("getAllBlogs()", () => {
    // TC_BLOG_07
    test("TC_BLOG_07 — Ném lỗi khi blogModel.findAll() ném lỗi DB", async () => {
  ...
  describe("getBlogsByCategory()", () => {
    ...
    // TC_BLOG_25
    test("TC_BLOG_25 — Ném lỗi khi model ném lỗi DB trong getBlogsByCategory", async () => {
      // Arrange
  ...
  describe("getAllBlogsAdmin()", () => {
    ...
    // TC_BLOG_28
    test("TC_BLOG_28 — Ném lỗi khi model ném lỗi DB trong getAllBlogsAdmin", async () => {
      // Arrange
  ...
  describe("searchBlogs() — error path", () => {
    // TC_BLOG_29
    test("TC_BLOG_29 — Ném lỗi khi model ném lỗi DB trong searchBlogs", async () => {
      // Arrange
  ...
  describe("createBlog() — error path", () => {
    // TC_BLOG_30
    test("TC_BLOG_30 — Ném lỗi khi model ném lỗi DB trong createBlog", async () => {
      // Arrange
  ...
  describe("updateBlog() — error path", () => {
    // TC_BLOG_31
    test("TC_BLOG_31 — Ném lỗi khi model ném lỗi DB trong updateBlog", async () => {
      // Arrange
  ...
  describe("deleteBlog() — error path", () => {
    // TC_BLOG_32
    test("TC_BLOG_32 — Ném lỗi khi model ném lỗi DB trong deleteBlog", async () => {
      // Arrange
  ...
  describe("addComment() — error path", () => {
    // TC_BLOG_33
    test("TC_BLOG_33 — Ném lỗi khi model ném lỗi DB trong addComment", async () => {
      // Arrange
